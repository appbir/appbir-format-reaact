...
export let injectionReducer = (_moduleName, _mapStateToProps, _mapDispatchToProps, _reducer, _mergeProps) => {
    ...
    return reduxWithConnect(mapStateToProps, mapDispatchToProps, 
        __mergeProps, { moduleName, _namespace:namespace,props:{}, initProps });
...
let reduxWithConnect = (mapStateToProps, mapDispatchToProps, mergeProps, option) => {
    let { moduleName, _namespace, initProps,props } = option;
    /**
     *  获取系统状态
    ...
    let _defaultOption={namespace:_namespace,moduleName,areaName:CONST.MODULE_NAME_PROP};
    ...
    const getMapStateToProps = (_reduxMapState) => {
        ...
        let namespaceReduxMapState = _namespace ? moduleReduxMapState[_namespace] : moduleReduxMapState;
    ...
    const getMapDispatchToProps = mapDispatchToProps ?
        (_dispatch, getState) => {
            ...
            let defaultOption={namespace:_namespace,moduleName,areaName:CONST.MODULE_NAME_PROP};
        ...
        class FrameConnect extends Component {
            constructor(props){
                ...
                if(window.NAMESPACE && namespace){
                    window.NAMESPACE[namespace] = _namespace
                }
            }
